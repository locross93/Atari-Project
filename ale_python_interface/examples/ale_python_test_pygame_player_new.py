...
# Author: Ben Goodrich
#
# This modified ale_python_test_pygame.py to provide a fully interactive
# experience allowing the player to play.
# RAM Contents, current action, and reward are also displayed.
# keys are:
...
game_surface = pygame.Surface(ale.screen_dims)
...
while episode < 10:
    ...
    font = pygame.font.SysFont("Ubuntu Mono",32)
    text = font.render("Current Action: %d" % a, 1, (208,208,255))
    height = font.get_height()*1.2
    ...
    text = font.render("Total Reward: %g" % total_reward, 1, (208,255,255))
    screen.blit(text,(330,line_pos))
